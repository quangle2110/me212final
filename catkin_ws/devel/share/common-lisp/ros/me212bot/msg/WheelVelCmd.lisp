...
(cl:defmethod cl:initialize-instance :after ((m <WheelVelCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelVelCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name me212bot-msg:<WheelVelCmd> is deprecated: use me212bot-msg:WheelVelCmd instead.")))
