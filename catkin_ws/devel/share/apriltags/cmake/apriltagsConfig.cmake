...
if("TRUE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/robot/me212Code/MobileRobot/catkin_ws/src/apriltags)
  set(apriltags_DEVEL_PREFIX /home/robot/me212Code/MobileRobot/catkin_ws/devel)
  ...
  set(apriltags_INSTALL_PREFIX /home/robot/me212Code/MobileRobot/catkin_ws/install)
...
if(NOT "/home/robot/me212Code/MobileRobot/catkin_ws/devel/include;/home/robot/me212Code/MobileRobot/catkin_ws/src/apriltags/include " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/me212Code/MobileRobot/catkin_ws/devel/include;/home/robot/me212Code/MobileRobot/catkin_ws/src/apriltags/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Aaron Walsman <awalsman@andrew.cmu.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/me212Code/MobileRobot/catkin_ws/src/apriltags/${idir}'.  Ask the maintainer 'Aaron Walsman <awalsman@andrew.cmu.edu>' to fix it.")
    endif()
...
set(apriltags_EXPORTED_TARGETS "apriltags_generate_messages_cpp;apriltags_generate_messages_eus;apriltags_generate_messages_lisp;apriltags_generate_messages_nodejs;apriltags_generate_messages_py")
...
set(depends "cv_bridge;std_msgs;sensor_msgs;image_transport;roscpp;geometry_msgs")
...
set(pkg_cfg_extras "apriltags-msg-extras.cmake")
